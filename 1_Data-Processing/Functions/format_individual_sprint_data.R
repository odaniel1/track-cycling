...
format_individual_sprint_data <- function(race_lookup){

  # Run checks to ensure data is valid.
  check_individual_sprint_data(race_lookup)
  ...
  sprints_wide <- generate_wide_sprints_data(matches)
  
  sprints_long <- generate_long_sprints_data(sprints_wide)
...
check_individual_sprint_data <- function(race_lookup){
...
generate_wide_sprints_data <- function(matches){
...
generate_long_sprints_data <- function(sprints_wide){
